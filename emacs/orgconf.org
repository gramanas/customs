...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key c++-mode-map (kbd "M-;") (function rtags-find-file))
  (define-key c++-mode-map (kbd "C-.") (function rtags-find-symbol))
  (define-key c++-mode-map (kbd "C-,") (function rtags-find-references))
