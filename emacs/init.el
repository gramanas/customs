...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet swiper smartparens pdf-tools packed monokai-theme magit linum-relative jump-char helm-swoop helm-projectile helm-flycheck helm-company fill-column-indicator f embrace darktooth-theme company-math color-theme-sanityinc-tomorrow change-inner auctex ace-window ace-mc))))
(custom-set-faces
